# Presentation Metric Audit and Verification
...
ruff check \
  normalize_gold_standard_192.py slide_number_definitions.py \
  audit_slide_number_definitions.py \
...
- SHA-256 of the pre-translation metric-verification artifact was
