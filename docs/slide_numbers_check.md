...
**コーパス**: `data/output/2511-2604_hybrid.csv` / `data/output/sentiment_classified_hybrid.csv` のみ

> 仕様書は一切書き換えていない。以下は報告のみ。

## 集計: 一致 86 / 不一致 10 / 検証不可 0（全 96 項目）
...
| 2-0 | `第弾` の過剰除去 | 2002 | 1042 | ★不一致 | 復帰分をNFKC+数字除去で検索（生/NFKCのみでは0件。全体では3,026件） |
...
| 2-3 | 正解セット件数 | 192 | 192 | 一致 | gold_standard_192.csv |
| 2-3 | 交換・取引 割合(%) | 28.1 | 28.1 | 一致 | gold_standard_192.csv |
| 2-3 | 交換・取引 95%CI | 21.7 – 34.5% | 21.8 – 34.5% | ★不一致 | 正規近似 |
| 2-3 | 中立 割合(%) | 25.0 | 25.0 | 一致 | gold_standard_192.csv |
| 2-3 | 中立 95%CI | 18.9 – 31.1% | 18.9 – 31.1% | 一致 | 正規近似 |
| 2-3 | 欲望・執着 割合(%) | 18.8 | 18.8 | 一致 | gold_standard_192.csv |
| 2-3 | 欲望・執着 95%CI | 13.2 – 24.3% | 13.2 – 24.3% | 一致 | 正規近似 |
| 2-3 | 喜び・満足 割合(%) | 17.2 | 17.2 | 一致 | gold_standard_192.csv |
| 2-3 | 喜び・満足 95%CI | 11.8 – 22.5% | 11.9 – 22.5% | ★不一致 | 正規近似 |
| 2-3 | 焦り・競争 割合(%) | 14.1 | 14.1 | 一致 | gold_standard_192.csv |
| 2-3 | 焦り・競争 95%CI | 9.2 – 19.0% | 9.1 – 19.0% | ★不一致 | 正規近似 |
| 2-3 | 不満・怒り 割合(%) | 7.3 | 7.3 | 一致 | gold_standard_192.csv |
| 2-3 | 不満・怒り 95%CI | 3.6 – 11.0% | 3.6 – 11.0% | 一致 | 正規近似 |
| 2-3 | 情報共有 割合(%) | 2.6 | 2.6 | 一致 | gold_standard_192.csv |
| 2-3 | 情報共有 95%CI | 0.4 – 4.8% | 0.4 – 4.9% | ★不一致 | 正規近似 |
...
| 2-4 | 上位1%のアカウント数 | 106 | 106 | 一致 | 計算 |
| 2-4 | 上位1%シェア(%) | 14.9 | 14.9 | 一致 | 計算 |
| 2-4 | 上位10%シェア(%) | 45.6 | 45.6 | 一致 | 計算 |
| 2-4 | 定型書式 件数 | 12181 | 12298 | ★不一致 | 2-4記載パターンを実装 |
| 2-4 | 定型書式 割合(%) | 50.1 | 50.6 | ★不一致 | 計算 |
...
| 2-5 | リプライ件数 | 79 | 80 | ★不一致 | リプライ先列 or 先頭@ |
| 2-5 | 中立と分類されていた件数 | 90 | 90 | 一致 | sentiment_classified_hybrid.csv |
| 2-5 | 「検索より/から失礼いたします」 | 48 | 48 | 一致 | 本文の正規表現検索 |
| 2-5 | 「ご検討」 | 42 | 41 | ★不一致 | 本文の正規表現検索 |
| 2-5 | 「初めまして」 | 31 | 31 | 一致 | 本文の正規表現検索 |
| 2-5 | 🙇 | 31 | 31 | 一致 | 本文の正規表現検索 |
| 2-5 | 交換比率(n:m) | 18 | 17 | ★不一致 | 本文の正規表現検索 |
| 2-5 | 「比率違い」 | 3 | 3 | 一致 | 本文の正規表現検索 |
